...
import grid_trainer as trainer
...
def main(argv):
    ...
    for idx in range(rank, len(configs), size):
        set_hyperparameter(model_type, optimizer_type, learning_rate_type, model_config, train_config, configs[idx])
        ...
        print(FLAGS.train_dir+str(idx))

        trainer.train(create_input_dict_fn, model_fn, train_config, master, task,
                      FLAGS.num_clones, worker_replicas, FLAGS.clone_on_cpu, ps_tasks,
                      worker_job_name, is_chief, FLAGS.train_dir+str(idx), idx)
