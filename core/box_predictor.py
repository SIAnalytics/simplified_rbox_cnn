...
class MaskRCNNBoxPredictor(BoxPredictor):
    ...
    def _predict(self, image_features, num_predictions_per_location, auxiliary=None):
        """Computes encoded object locations and corresponding confidences.
        ...
        Args:
          ...
          num_predictions_per_location: an integer representing the number of box
            predictions to be made per spatial location in the feature map.
            Currently, this must be set to 1, or an error will be raised.
          auxiliary: A float tensor of shape [batch_size, None] containing auxiliary features.
        ...
        with slim.arg_scope(self._fc_hyperparams):
            ...
            if auxiliary is not None:
                flattened_image_features = tf.concat([flattened_image_features, auxiliary], axis=1)
