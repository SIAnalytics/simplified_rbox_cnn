...
PREPROCESSING_FUNCTION_MAP = {
    ...
    'random_horizontal_flip_rbox': preprocessor.random_horizontal_flip_rbox,
    'random_vertical_flip_rbox': preprocessor.random_vertical_flip_rbox,
    'random_rotate_rbox': preprocessor.random_rotate_rbox,
}
