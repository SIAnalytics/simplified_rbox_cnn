...
class PreprocessorBuilderTest(tf.test.TestCase):
    ...
    def test_build_random_horizontal_flip_rbox(self):
        preprocessor_text_proto = """
        ...
        text_format.Merge(preprocessor_text_proto, preprocessor_proto)
        function, args = preprocessor_builder.build(preprocessor_proto)
        self.assertEqual(function, preprocessor.random_horizontal_flip_rbox)
        self.assertEqual(args, {})

    def test_build_random_vertical_flip_rbox(self):
        preprocessor_text_proto = """
        ...
        text_format.Merge(preprocessor_text_proto, preprocessor_proto)
        function, args = preprocessor_builder.build(preprocessor_proto)
        self.assertEqual(function, preprocessor.random_vertical_flip_rbox)
        self.assertEqual(args, {})

    def test_build_random_rotataion_rbox(self):
        preprocessor_text_proto = """
        random_rotate_rbox {
          min_value: -0.1
          max_value:  0.1
        ...
        text_format.Merge(preprocessor_text_proto, preprocessor_proto)
        function, args = preprocessor_builder.build(preprocessor_proto)
        self.assertEqual(function, preprocessor.random_rotate_rbox)
        self.assert_dictionary_close(args, {'min_value': -0.1, 'max_value': 0.1})
