...
def build(anchor_generator_config):
    ...
    if anchor_generator_config.WhichOneof(
        ...
        return multiple_grid_anchor_generator.create_ssd_anchors(
            ...
            num_aspect_ration_of_middle_scale=ssd_anchor_generator_config.num_aspect_ration_of_middle_scale)
    elif anchor_generator_config.WhichOneof(
            'anchor_generator_oneof') == 'rssd_anchor_generator':
        rssd_anchor_generator_config = anchor_generator_config.rssd_anchor_generator
        return multiple_grid_rbbox_anchor_generator.create_rssd_anchors(
            num_layers=rssd_anchor_generator_config.num_layers,
            min_scale=rssd_anchor_generator_config.min_scale,
            max_scale=rssd_anchor_generator_config.max_scale,
            aspect_ratios=rssd_anchor_generator_config.aspect_ratios,
            angles=rssd_anchor_generator_config.angles,
            reduce_boxes_in_lowest_layer=rssd_anchor_generator_config.reduce_boxes_in_lowest_layer,
            num_aspect_ration_of_middle_scale=rssd_anchor_generator_config.num_aspect_ration_of_middle_scale)
    elif anchor_generator_config.WhichOneof(
            'anchor_generator_oneof') == 'grid_rbbox_anchor_generator':
        grid_rbbox_anchor_generator_config = anchor_generator_config.grid_rbbox_anchor_generator
        return grid_rbbox_anchor_generator.GridRbboxAnchorGenerator(
            scales=[float(scale) for scale in grid_rbbox_anchor_generator_config.scales],
            aspect_ratios=[float(aspect_ratio) for aspect_ratio in grid_rbbox_anchor_generator_config.aspect_ratios],
            angles=[float(angle) for angle in grid_rbbox_anchor_generator_config.angles],
            base_anchor_size=[grid_rbbox_anchor_generator_config.height,
                              grid_rbbox_anchor_generator_config.width],
            anchor_stride=[grid_rbbox_anchor_generator_config.height_stride,
                           grid_rbbox_anchor_generator_config.width_stride],
            anchor_offset=[grid_rbbox_anchor_generator_config.height_offset,
                           grid_rbbox_anchor_generator_config.width_offset])
    else:
