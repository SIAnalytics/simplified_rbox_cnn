...
def _build_non_max_suppressor(nms_config):
    ...
    if nms_config.box_type == post_processing_pb2.BatchNonMaxSuppression.BBOX:
    ...
    elif nms_config.box_type == post_processing_pb2.BatchNonMaxSuppression.RBBOX:
        non_max_suppressor_fn = functools.partial(
            ...
            max_size_per_class=nms_config.max_detections_per_class,
            max_total_size=nms_config.max_total_detections,
            handle_as_single_class=nms_config.handle_as_single_class)
